sap.ui.define([
	...
	return BaseController.extend("com.sap.build.sapcsr.SOLCONT.controller.App", {
		...
		onInit: function() {
			...
			var oModel = new sap.ui.model.json.JSONModel("model/Dados.json");
		...
		onItemSelect: function(oEvent) {
			...
			if ((sKey === "home" || sKey === "masterSettings" || sKey === "solicitacoes")) {
			...
			else if(sKey === "contratoJuridico" ){ //informando o target 'contrato' para capturar no evento attachPatternMatched 
